...
import { Plus, FileText, Image as ImageIcon, Box, Upload, Download, CheckCircle, Clock, MoreHorizontal, X, Eye, File } from 'lucide-react';
...
const INITIAL_PROJECTS = [
  {
    ...
    outputs: [
      ...
      { type: 'stp', name: 'Watch_Case_v1.stp' }
    ]
  },
  {
    id: 2,
      ...
      <div className="h-[calc(100vh-100px)] flex flex-col gap-6">
        ...
        <div className="flex items-center gap-4 border-b border-slate-200 pb-4">
          <button onClick={() => setViewMode('list')} className="p-2 hover:bg-slate-100 rounded-full">
            <div className="rotate-180"><MoreHorizontal size={20}/></div>
